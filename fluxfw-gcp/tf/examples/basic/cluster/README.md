...
in this example with the Flux Framework images built with Cloud Build to instantiate a cluster node Compute Engine instances
managed by the Flux Framework resource job management software.
