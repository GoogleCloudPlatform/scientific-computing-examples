...
apptainer build namd/ docker://nvcr.io/hpc/namd:$NAMD_TAG 
```
...
#SBATCH --partition=a2
#SBATCH --output=%3A/out_%3A.txt
#SBATCH --error=%3A/err_%3A.txt

apptainer run --nv namd namd3 +p1 +devices 0,1 +setcpuaffinity apoa1/apoa1_nve_cuda_soa.namd
JOB
```
