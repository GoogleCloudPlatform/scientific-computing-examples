...
PROJECT_ID = 'gromacs-demo-jrt'
INCOMING_TOPIC_ID = 'fsi_topic_montecarlo'
INCOMING_TOPIC_SCHEMA = 'fsi_schema_montecarlo'
DATASET_ID = 'fsi_dataset_montecarlo'
TABLE_ID = 'fsi_table_montecarlo'
