...
| <a name="output_repo_path"></a> [repo\_path](#output\_repo\_path) | URL with path of the created Repository |
| <a name="output_repo_url"></a> [repo\_url](#output\_repo\_url) | URL of the created Repository |
