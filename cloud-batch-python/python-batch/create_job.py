...
class CreateJob:
  ...
  def create_allocation_policy(self) -> batch_v1.AllocationPolicy:
      ...
      location_policy.allowed_locations = ["regions/us-central1", "zones/us-central1-a", "zones/us-central1-b"]
  ...
  def create_job(self):
      ...
      self.job.labels = self.config["labels"] if "labels" in self.config else {"env": "wdc", "type": "fftw"}
